...
The Ansible playbook is executed once to prepare the system (Docker, Minikube, kubectl). This step is not part of the CI/CD pipeline and is intentionally kept separate.
...
Webhooks require GitHub to reach Jenkins. That means Jenkins must be:
- Publicly accessible OR
- Temporarily exposed using ngrok

Since your Jenkins is running locally, we'll use ngrok. This is normal and correct.
